...
function love.draw()
    ...
    love.graphics.print("Second Highest Score: " .. math.floor(secondScore), 10, 55)
    love.graphics.print("Most Recent Score: " .. math.floor(mostRecentScore), 10, 75)
